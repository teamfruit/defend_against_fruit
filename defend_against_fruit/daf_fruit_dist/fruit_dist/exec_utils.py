...
def build_sdist():
    subprocess.check_call([
        sys.executable, 'setup.py', 'sdist', '--formats=gztar', 'freeze', 'module_generator'])


def build_and_deploy_sdist():
    subprocess.check_call([
        sys.executable, 'setup.py', 'sdist', '--formats=gztar', 'freeze', 'module_generator', 'artifactory_upload'])
