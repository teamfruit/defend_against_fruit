...
#             """
#             Replace the first directory in the relative path with
#             dest_base_url.
#             """
#             return os.path.join(
#                 dest_base_url,
#                 *os.path.split(relative_path)[1:])
#         self.__response_map = {
#             _convert_path(path): (response, output) for
#             path, response, output in response_map}
#         self.gets = {}
#
...
#         (
#             'python/nose',
#             MockResponse(text=_read_file(
#                 relative_path=('resources', 'nose', 'input.html'))),
#             MockResponse(text=_read_file(
#                 relative_path=('resources', 'nose', 'output.html')))
#         ),
#         # (
#         #     'python/nose/nose-1.3.0.tar.gz',
#         #     MockResponse(content=_read_file(
#         #           relative_path=('resources', 'nose', 'redirect', 'nose-1.3.0.tar.gz'))),
#         #     MockResponse(content=_read_file(
#         #           relative_path=('resources', 'nose', 'redirect', 'nose-1.3.0.tar.gz')))
#         # )
#     )
